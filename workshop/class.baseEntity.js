class BaseEntity {
  ...
  render() {
    ...
    if (this instanceof Robot || this instanceof Player) {
      let width = 15;
      width = (width / this.totalEnergy) * this.energy;
      ctx.fillStyle = 'green';
      ctx.fillRect(Math.round(this.x - (16/2)), Math.round(this.y + 8), width, 3);
    }
  }

  getDistance(other, distance = 8) {
